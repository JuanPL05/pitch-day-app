"use strict";(()=>{var e={};e.id=228,e.ids=[228,568],e.modules={517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},4842:(e,t,a)=>{a.r(t),a.d(t,{headerHooks:()=>N,originalPathname:()=>p,patchFetch:()=>h,requestAsyncStorage:()=>E,routeModule:()=>d,serverHooks:()=>m,staticGenerationAsyncStorage:()=>T,staticGenerationBailout:()=>g});var i={};a.r(i),a.d(i,{DELETE:()=>l,PUT:()=>u});var r=a(5419),o=a(9108),s=a(9678),n=a(8070),c=a(9568);async function u(e,{params:t}){try{let{name:a,email:i}=await e.json();console.log("[v0] Updating judge:",t.id,{name:a,email:i});let r=`
    ...
    `),await s.query(`
      ...
      ON CONFLICT (id) DO NOTHING
    `),console.log("[v0] Database initialized successfully"),{success:!0}}catch(e){return console.error("[v0] Database initialization failed:",e),{success:!1,error:e.message}}}}};var t=require("../../../../webpack-runtime.js");t.C(e);var a=e=>t(t.s=e),i=t.X(0,[638,539,206],()=>a(4842));module.exports=i})();