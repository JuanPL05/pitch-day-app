"use strict";(()=>{var e={};e.id=307,e.ids=[307,568],e.modules={517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},649:(e,t,a)=>{a.r(t),a.d(t,{headerHooks:()=>m,originalPathname:()=>p,patchFetch:()=>g,requestAsyncStorage:()=>d,routeModule:()=>l,serverHooks:()=>T,staticGenerationAsyncStorage:()=>E,staticGenerationBailout:()=>N});var i={};a.r(i),a.d(i,{POST:()=>u});var o=a(5419),s=a(9108),r=a(9678),n=a(8070),c=a(9568);async function u(){try{let e=`
    ...
    `),await r.query(`
      ...
      ON CONFLICT (id) DO NOTHING
    `),console.log("[v0] Database initialized successfully"),{success:!0}}catch(e){return console.error("[v0] Database initialization failed:",e),{success:!1,error:e.message}}}}};var t=require("../../../../webpack-runtime.js");t.C(e);var a=e=>t(t.s=e),i=t.X(0,[638,539,206],()=>a(649));module.exports=i})();