"use strict";(()=>{var e={};e.id=684,e.ids=[684,568],e.modules={517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},7893:(e,t,a)=>{a.r(t),a.d(t,{headerHooks:()=>p,originalPathname:()=>N,patchFetch:()=>h,requestAsyncStorage:()=>E,routeModule:()=>d,serverHooks:()=>m,staticGenerationAsyncStorage:()=>T,staticGenerationBailout:()=>g});var i={};a.r(i),a.d(i,{GET:()=>u,POST:()=>l});var r=a(5419),o=a(9108),s=a(9678),n=a(8070),c=a(9568);async function u(){try{console.log("[v0] Fetching judges...");let e=await (0,c.executeQuery)('SELECT * FROM judges ORDER BY "createdAt" DESC');return console.log("[v0] Judges fetched successfully:",e.length),n.Z.json(e)}catch(e){return console.error("[v0] Error fetching judges:",e),(0,c.Lb)(e,"Failed to fetch judges")}}async function l(e){try{let{name:t,email:a}=await e.json();console.log("[v0] Creating judge:",{name:t,email:a});let i=t.replace(/[áàäâ]/g,"a").replace(/[éèëê]/g,"e").replace(/[íìïî]/g,"i").replace(/[óòöô]/g,"o").replace(/[úùüû]/g,"u").replace(/[ñ]/g,"n").replace(/[ç]/g,"c").replace(/[ÁÀÄÂ]/g,"A").replace(/[ÉÈËÊ]/g,"E").replace(/[ÍÌÏÎ]/g,"I").replace(/[ÓÒÖÔ]/g,"O").replace(/[ÚÙÜÛ]/g,"U").replace(/[Ñ]/g,"N").replace(/[Ç]/g,"C").replace(/[^a-zA-Z0-9]/g,""),r=`
    ...
    `),await s.query(`
      ...
      ON CONFLICT (id) DO NOTHING
    `),console.log("[v0] Database initialized successfully"),{success:!0}}catch(e){return console.error("[v0] Database initialization failed:",e),{success:!1,error:e.message}}}}};var t=require("../../../webpack-runtime.js");t.C(e);var a=e=>t(t.s=e),i=t.X(0,[638,539,206],()=>a(7893));module.exports=i})();