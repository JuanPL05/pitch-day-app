"use strict";(()=>{var e={};e.id=281,e.ids=[281,568],e.modules={517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},1165:(e,t,a)=>{a.r(t),a.d(t,{headerHooks:()=>N,originalPathname:()=>h,patchFetch:()=>g,requestAsyncStorage:()=>E,routeModule:()=>d,serverHooks:()=>m,staticGenerationAsyncStorage:()=>T,staticGenerationBailout:()=>p});var i={};a.r(i),a.d(i,{GET:()=>u,POST:()=>l});var r=a(5419),o=a(9108),s=a(9678),n=a(8070),c=a(9568);async function u(){try{console.log("[v0] Fetching teams...");let e=await (0,c.executeQuery)('SELECT * FROM teams ORDER BY "createdAt" DESC');return console.log("[v0] Teams fetched successfully:",e.length),n.Z.json(e)}catch(e){return console.error("[v0] Error fetching teams:",e),(0,c.Lb)(e,"Failed to fetch teams")}}async function l(e){try{let{name:t,description:a}=await e.json();console.log("[v0] Creating team:",{name:t,description:a});let i=`
    ...
    `),await s.query(`
      ...
      ON CONFLICT (id) DO NOTHING
    `),console.log("[v0] Database initialized successfully"),{success:!0}}catch(e){return console.error("[v0] Database initialization failed:",e),{success:!1,error:e.message}}}}};var t=require("../../../webpack-runtime.js");t.C(e);var a=e=>t(t.s=e),i=t.X(0,[638,539,206],()=>a(1165));module.exports=i})();